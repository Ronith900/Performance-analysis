...
def register(request):
    ...
    return render(request, 'analysis/register.html', {'form': form, 'title': request.user.username})
...
def create_term(request):
    if request.method == 'POST':
        ...
        form = CreateTerm()
    return render(request, 'analysis/create_term.html', {'form': form, 'title': request.user.username})
